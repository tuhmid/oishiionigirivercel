  ...
  return (
    <main style={{
      ...
      <section className="hero">
        ...
        {/* Social links */}
        <style>{`.hero-social-link { color: var(--ink-40); transition: color 0.15s; } .hero-social-link:hover { color: var(--ink); }`}</style>
        <div style={{ display: 'flex', gap: 'var(--sp-5)', marginTop: 'var(--sp-8)', alignItems: 'center' }}>
          <a href="https://www.instagram.com/oishiionioni/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="hero-social-link">
          ...
          <a href="https://www.tiktok.com/@oishiionioni" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="hero-social-link">
            <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor">
              <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.69a8.17 8.17 0 0 0 4.78 1.52V6.75a4.85 4.85 0 0 1-1.01-.06z"/>
            </svg>
          </a>
          <a href="https://www.linkedin.com/company/oishiionigiri" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="hero-social-link">
            <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor">
