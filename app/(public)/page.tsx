    ...
    <main style={{
      ...
      <section className="hero">
        ...
        <div style={{ display: 'flex', gap: 'var(--sp-5)', marginTop: 'var(--sp-8)', alignItems: 'center' }}>
          <a href="https://www.instagram.com/oishiionioni/" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
            style={{ color: 'var(--ink-40)', transition: 'color 0.15s' }}
          ...
          <a href="https://www.tiktok.com/@oishiionioni" target="_blank" rel="noopener noreferrer" aria-label="TikTok"
            style={{ color: 'var(--ink-40)', transition: 'color 0.15s' }}
            onMouseEnter={e => (e.currentTarget.style.color = 'var(--ink)')}
            onMouseLeave={e => (e.currentTarget.style.color = 'var(--ink-40)')}
          >
          ...
          <a href="https://www.linkedin.com/company/oishiionigiri" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"
            style={{ color: 'var(--ink-40)', transition: 'color 0.15s' }}
            onMouseEnter={e => (e.currentTarget.style.color = 'var(--ink)')}
            onMouseLeave={e => (e.currentTarget.style.color = 'var(--ink-40)')}
          >
